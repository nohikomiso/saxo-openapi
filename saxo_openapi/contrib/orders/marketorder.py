...
class MarketOrderCfdOnStock(MarketOrder):
    """MarketOrderCfdOnStock - MarketOrder for CfdOnStock only.

    The MarketOrderCfdOnStock lacks the AssetType parameter and only serves
    ...
    def __init__(
        ...
        """
        super(MarketOrderCfdOnStock, self).__init__(
            Uic=Uic,
            Amount=Amount,
            AmountType=AmountType,
            ManualOrder=ManualOrder,
