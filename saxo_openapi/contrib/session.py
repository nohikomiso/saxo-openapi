...
def account_info2(client):
    """account_info2 - fetch some key account information.

    Fetch accountinformation_secondary and return it as a namedtuple.
    ...
    t = namedtuple("AcctInfo", "ClientId ClientKey AccountId AccountKey")
    ai = t(
        ClientId=rv["Data"][1]["ClientId"],
        ClientKey=rv["Data"][1]["ClientKey"],
        AccountId=rv["Data"][1]["AccountId"],
        AccountKey=rv["Data"][1]["AccountKey"],
    )
